namespace API.Utility
{
	public static class SM
	{
		...
		public const string T_PasswordReset = "Password reset";
		...
		public const string M_ConfirmEmailSent = "If an eligible account exists, we've sent account activation instructions to its primary email. Check your inbox or spam folder.";
		...
		public const string M_PasswordReset = "Your password has been reset.";
